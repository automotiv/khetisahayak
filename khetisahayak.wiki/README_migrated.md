...
Our team is structured to drive innovation and growth, ensuring we meet the needs of the farmers we serve. For more detailed project documentation, please visit our [**Project Wiki**](khetisahayak.wiki/Home.md).

| Team | Core Responsibilities |
| :--- | :--- |
| **CEO/Co-Founders** | Strategy, Fundraising, Partnerships |
| **Product & Tech** | AI, SaaS, Platform features, Integrations |
| **Growth/Field Teams** | User acquisition, Channel expansion |
| **Customer Success** | Farmer advocacy, Retention |
| **Finance/HR** | Hiring, managing resources, compliance |
...
This roadmap outlines the strategic direction for Kheti Sahayak, aligning key initiatives with the teams responsible for their execution.

| Phase | Quarter | Theme | Key Initiatives & Goals | Lead Roles |
| :--- | :--- | :--- | :--- | :--- |
| **Phase 1** | **Q1-Q2** | **Foundation & Launch** | **Platform:** Launch v1.0 with core features (Diagnostics, Marketplace, Content). <br> **Growth:** Onboard first 10,000 farmers in pilot regions. <br> **Success:** Establish farmer feedback channels. <br> **Ops:** Secure seed funding. | Product & Tech, Growth/Field Teams, Customer Success, CEO/Co-Founders |
| **Phase 2** | **Q3-Q4** | **Scale & Enhance** | **Platform:** Enhance AI models, add Expert Connect, expand language support. <br> **Growth:** Expand to 5 new states; target 100,000 users. <br> **Success:** Achieve 4.5+ app store rating. <br> **Ops:** Strategic partnerships with agricultural institutions. | Product & Tech, Growth/Field Teams, Customer Success, CEO/Co-Founders |
| **Phase 3** | **Q1-Q2 (Next Year)** | **Monetization & Ecosystem** | **Platform:** Launch Marketplace v2.0 (transactions, logistics), introduce premium features. <br> **Growth:** Develop B2B channels with input providers. <br> **Success:** Implement farmer retention programs. <br> **Ops:** Series A fundraising; expand the team. | Product & Tech, Growth/Field Teams, Customer Success, Finance/HR, CEO/Co-Founders |
| **Phase 4** | **Q3-Q4 (Next Year)** | **Innovation & Expansion** | **Platform:** Pilot IoT sensor integration, introduce price prediction models. <br> **Growth:** Explore international markets. <br> **Success:** Build a strong farmer advocacy program. <br> **Ops:** Ensure regulatory compliance for new markets. | Product & Tech, Growth/Field Teams, Customer Success, Finance/HR, CEO/Co-Founders |
...
│
├── 🌐 kheti_sahayak_web/              # React/Vite Web Portal
│   ├── src/                          # Source files
