...
import { Box, Typography, Card, CardContent, Stack, Button, Alert, Grid } from '@mui/material'; // Added Grid
import { TrendingUp, Notifications, LocalHospital, School } from '@mui/icons-material';
import WeatherCard from '../weather/WeatherCard';
import NewsWidget from '../news/NewsWidget'; // Imported NewsWidget
import MarketPriceWidget from '../marketplace/MarketPriceWidget'; // Added MarketPriceWidget
